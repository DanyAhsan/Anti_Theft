...
public class VideoRecorder extends Service implements SurfaceHolder.Callback {

    private static final String tag_ = VideoRecorder.class.getSimpleName();
        ...
        try {
            ...
            if (getCameraInfoMethod != null && cameraInfoClass != null && field != null) {
                for (int camIdx = 0; camIdx < cameraCount; camIdx++) {
                    ...
                    if (facing == 1 || facing == 0 || facing == 3) { // Camera.CameraInfo.CAMERA_FACING_FRONT
                        try {
